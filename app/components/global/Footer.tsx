      ...
      <div className="container mx-auto px-6 py-12">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="inline-block mb-4">
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                Palth<span className="text-white">.dev</span>
              </span>
            </Link>
            <p className="text-gray-400 mb-4">
              Creating elegant digital experiences with modern technologies.
            </p>
            
            {/* Social Icons */}
            <div className="flex space-x-4 mt-4">
              {[
                { name: "GitHub", icon: "github", url: "https://github.com/palthol" },
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start">
                ...
                <a href="mailto:ilikericeat@gmail.com" className="hover:text-white transition-colors">
                  ilikericeat@gmail.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="mr-2">📱</span>
              ...
              <li className="flex items-start">
                <span className="mr-2">📍</span>
                <span>Based in Tennessee, USA</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            © {currentYear} Palth.dev. All rights reserved.
          </p>
